...
// import 'package:google_sign_in/google_sign_in.dart'; // Commented out
// import 'package:sign_in_with_apple/sign_in_with_apple.dart'; // Commented out
// import 'package:mongo_dart/mongo_dart.dart' as mongo; // Commented out
...
class _CompleteProfileScreenState extends State<CompleteProfileScreen> {
  ...
  void initState() {
    super.initState();
    // _connectToMongoDB(); // Commented out
  }
  ...
  // Future<void> _googleSignIn() async { // Commented out
  //   final GoogleSignIn googleSignIn = GoogleSignIn(); // Commented out
  //   try {
  //     final GoogleSignInAccount? googleUser = await googleSignIn.signIn(); // Commented out
  //     if (googleUser != null) {
  //       _nameController.text = googleUser.displayName ?? '';
  //       _emailController.text = googleUser.email;
  //       // _checkDataExists(); // Commented out
  ...
  // Future<void> _appleSignIn() async { // Commented out
  //   try {
